  ...
  if (os9x_softrendering==3) {  	
		if ((endy-starty+1>=PSP_GU_RENDER_MIN_UPDATED_LINES)&&
			...
			/*if (!os9x_render)	{
				...
				dst=(u32*)(0x04000000+512*272*2*2+256*240*2+2*256*256*2+starty*256*2 );
